...
query(ANY, ANY, lambda x_0, y_1: print(Triple(Iri('http://example.org/result'), Iri('http://example.org/cell'), Collection([Var('x_0'), Var('y_1')])).instantiate({'x_0': x_0, 'y_1': y_1})))