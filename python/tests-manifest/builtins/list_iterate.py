...
def query(c_0, final_ctu):
    ...
    rule_0(c_0, lambda c_1: final_ctu(c_1))
...
query(ANY, lambda c_0: print(Triple(Iri('http://example.org/result'), Iri('http://example.org/cell'), Var('c_0')).instantiate({'c_0': c_0})))