...
def query(a_0, x_1, xl_2, final_ctu):
    ...
    rule_0(a_0, x_1, xl_2, lambda a_3, x_4, xl_5: final_ctu(a_3, x_4, xl_5))
...
def rule_0(a_3, x_4, xl_5, final_ctu):
    ...
    rule_1(a_3, x_4, x_4, lambda q_6, k_7, l_8: rule_0_1(q_6, l_8, xl_5, final_ctu) if k_7 == l_8 else False)
...
query(ANY, ANY, ANY, lambda a_0, x_1, xl_2: print(Triple(Var('a_0'), Iri('http://example.org/partLabels'), Collection([Var('x_1'), Var('xl_2')])).instantiate({'a_0': a_0, 'x_1': x_1, 'xl_2': xl_2})))