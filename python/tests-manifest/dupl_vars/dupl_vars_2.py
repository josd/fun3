...
def query(a_0, x_1, y_2, xl_3, final_ctu):
    ...
    rule_0(a_0, x_1, y_2, xl_3, lambda a_4, x_5, y_6, xl_7: final_ctu(a_4, x_5, y_6, xl_7))
...
def rule_0(a_4, x_5, y_6, xl_7, final_ctu):
    ...
    if x_5 == y_6:
        rule_1(a_4, y_6, lambda q_8, x_9: rule_0_1(q_8, x_9, x_9, xl_7, final_ctu))
...
query(ANY, ANY, ANY, ANY, lambda a_0, x_1, y_2, xl_3: print(Triple(Var('a_0'), Iri('http://example.org/partLabels'), Collection([Var('x_1'), Var('y_2'), Var('xl_3')])).instantiate({'a_0': a_0, 'x_1': x_1, 'y_2': y_2, 'xl_3': xl_3})))