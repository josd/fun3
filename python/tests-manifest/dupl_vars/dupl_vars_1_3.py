...
def query(a_0, b_1, final_ctu):
    ...
    if a_0 == b_1:
        rule_0(b_1, lambda a_2: final_ctu(a_2, a_2))
...
def rule_0(a_2, final_ctu):
    ...
    rule_1(a_2, Collection([Var('x_3'), Var('y_4')]), lambda q_7, a_8: rule_0_1(q_7, a_8[0], a_8[1], final_ctu))
...
query(ANY, ANY, lambda a_0, b_1: print(Triple(Var('a_0'), Iri('http://example.org/part'), Var('b_1')).instantiate({'a_0': a_0, 'b_1': b_1})))